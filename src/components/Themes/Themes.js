          ...
          >
            ...
            <div className="md:col-span-3 bg-gray-900 clip-class-theme p-8 2xl:my-20 xl:pt-16 ">
              ...
              <div className="m-auto">
                ...
                <br />
                <strong>
                <a href={e.link} className="text-lg md:text-xl lg:text-2xl header-theme min-h-full" target="_blank" rel="noopener noreferrer">Click here to view problem statements</a></strong>
                <br />
              </div>
            </div>
          </div>
